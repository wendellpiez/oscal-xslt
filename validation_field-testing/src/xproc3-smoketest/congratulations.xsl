...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <!-- Input: an XML document in no namespace with a single element CONGRATULATIONS, in no namespace, with plain text content, as in the pipeline file ../../hello-morgana.xp3 -->
